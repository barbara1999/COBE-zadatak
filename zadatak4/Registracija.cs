...
namespace SeleniumTests
{
    ...
    public class Registracija
    {
        ...
        public void TheRegistracijaTest()
        {
            ...
            driver.FindElement(By.Id("input-email")).SendKeys("john_doe01@gmail.com");
            driver.FindElement(By.Id("input-telephone")).Click();
            driver.FindElement(By.Id("input-telephone")).Clear();
            driver.FindElement(By.Id("input-telephone")).SendKeys("111111");
            driver.FindElement(By.Id("input-password")).Click();
            driver.FindElement(By.Id("input-password")).Clear();
            driver.FindElement(By.Id("input-password")).SendKeys("lozinka");
            driver.FindElement(By.Id("input-confirm")).Click();
            driver.FindElement(By.Id("input-confirm")).Clear();
            driver.FindElement(By.Id("input-confirm")).SendKeys("lozinka");
